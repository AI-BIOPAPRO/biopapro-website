...
export const PRODUCT_CATALOG: Product[] = [
  {
    ...
    description: "Designed carefully for structural integrity and thermal resistance. Crafted with dual-reinforced neck curves to withstand temperatures up to 100°C without warping, taste transfer, or structural breakdown.",
    ...
    imageUrl: "https://picsum.photos/seed/woodfork/600/400"
  },
  {
    id: "premium-spoons",
    ...
    description: "Engineered specifically to solve the 'dry mouth feel' often associated with generic wooden cutlery. Our unique polished scoop architecture mimics ceramic ergonomics while maintaining lightweight compostability.",
    material: "100% Organic White Birchwood (FSC Certified)",
    ...
    densityClass: "Heavy Grade Birch (HGB-750)",
    imageUrl: "https://picsum.photos/seed/woodspoon/600/400"
  },
  {
    id: "premium-knives",
    ...
    description: "Provides exceptional shearing force for cooked proteins and fibrous agricultural grains. Designed with multi-layered compression to secure rigidity without fracturing under dense lateral loads.",
    ...
    imageUrl: "https://picsum.photos/seed/woodknife/600/400"
  },
  {
    id: "coffee-stirrers",
    ...
    description: "The global gold standard for premium cafe franchises and airline carrier service. Engineered with perfectly rounded ends to protect paper cup liners, and double-dried to prevent warping in deep boiling coffee.",
    ...
    imageUrl: "https://picsum.photos/seed/woodstirrer/600/400"
  },
  {
    id: "icecream-sticks",
    ...
    description: "Serrated-free, precise calibrated sticks developed for ultra-low friction on rapid ice cream extrusion lines. Designed to fit high-speed industrial machinery flawlessly with strict tolerances under 0.1mm.",
    ...
    imageUrl: "https://picsum.photos/seed/icestick/600/400"
  },
  {
    id: "premium-skewers",
    ...
    description: "Heavy-duty skewers equipped with smooth circular shafts to secure uniform cooking results. Specifically dried to resist active burning or splintering during high-heat barbecue service.",
    ...
    imageUrl: "https://picsum.photos/seed/woodskewer/600/400"
  }
];
...
export const CERTIFICATIONS = [
  {
    ...
    description: "Ensures all wood is sourced from strictly monitored, non-monoculture, sustainably-managed state forests. Completely prevents unauthorized deforestation and supports ecosystem biodiversity.",
    iconName: "Trees"
  },
  {
    id: "sgs-food",
    ...
    description: "Certifies that the raw birchwood is completely free of industrial chemicals, formaldehydes, optical brighteners, lead, or plasticizers under rigorous water and acetic acid extraction testing.",
  ...
  },
  {
    ...
    description: "Guarantees complete soil assimilation. The product biodegrades back into natural organic compost within 90 days in home or industrial composting environments, leaving zero heavy metal residue.",
  ...
  },
  {
    ...
    description: "Audits and certifies that the manufacturing plants guarantee humane working hours, fair living wages, strict occupational safety equipment (PPE), and child-labor-free supply lines.",
    iconName: "BadgeCheck"
  },
  {
    id: "iso-9001",
    ...
    description: "Guarantees absolute manufacturing consistency, with real-time digital laser measurement of product thickness, structural tolerances under 0.05mm, and comprehensive traceability.",
    iconName: "Cpu"
  }
];
...
export const MANUFACTURING_STEPS = [
  {
    ...
    description: "White birch logs are chosen from frozen Siberian or Northern temperate zones when winter humidity levels are lowest. Outer rough bark is cleanly peeled, leaving the clean, nutrient-neutral heartwood fibers ready for slicing.",
    icon: "TreePine"
  },
  {
    step: 2,
    ...
    description: "High-speed rotary lathes slice logs into incredibly thin, uniform ribbons of wood (exactly 1.2mm to 2.4mm thick). Precision digital micrometers inspect uniform density across every micron of wood grain.",
    icon: "Scissors"
  },
  {
    step: 3,
    ...
    description: "Hydraulic press dies stamp out the raw 2D contours of cutlery or spoons. A patented physical steam-conditioning system makes the hardwood temporarily elastic, allowing the deep 3D structural indent of forks and spoons.",
    icon: "Layers"
  },
  {
    step: 4,
    ...
    description: "Cutlery items pass through hot dry airflow ovens heated to 150°C. This reduces natural moisture below 8%, sealing the internal structures and sterilizing the wood against any organic mold or bacteria without chemical sanitizers.",
    icon: "FlameKindling"
  },
  {
    step: 5,
    ...
    description: "Spoons and forks tumble in a multi-stage dry mechanical drum with organic wood shavings for 24-48 hours. This burnishes every edge to liquid-smooth perfection. Custom brand logos are then laser-embossed with micron level accuracy.",
    icon: "Sparkles"
  },
  {
    step: 6,
    ...
    description: "Smart 4K optical sorting machines reject products with structural knots, dimensional variances, or micro-cracks. Verified perfect pieces are wrapped in high-density sterilized unbleached craft paper, ready for export.",
    icon: "Boxes"
  }
];

export const SUSTAINABLE_MATRIX_METRICS = {
  treesPlantedDailyEquivalent: 340,
  landfillCubicMetersAvoidedPerThousand: 0.12,
  carbonSavedKgPerThousand: 4.8, // 4.8kg CO2 saved per 1000 wooden cutlery relative to virgin plastic
